...
const Steps = ({ first, second, third ,marginTop}) => {
  return (
    <View style={{ width: wp(80), alignSelf: "center", marginBottom: hp(3),marginTop:marginTop?hp(3):undefined }}>
      ...
      >
        ...
        <View
          style={{
            flex: 1,
            height: 2,
            backgroundColor: second || third ? colors.secondary : colors.black,
          }}
        />
        ...
        <View style={{ flex: 1, height: 2, backgroundColor: third ? colors.secondary : colors.black }} />
      ...
      >
        <ResponsiveText size={2.7}>1. Your Cart</ResponsiveText>
