  ...
  return (
    ...
    alignItems: "center",
      ...
      <SelectDropdown
        ...
        buttonStyle={{
          backgroundColor: props.backgroundColor ? props.backgroundColor : colors.lightGrey,
          height: props.btnheight ? props.btnheight : hp(5),
          width: props.btnwidth ? props.btnwidth : wp(37),
          borderRadius:10,
      ...
      />
            <Icon margin={[0,10,0,0]} tintColor={colors.grey1} source={globalPath.list} />
